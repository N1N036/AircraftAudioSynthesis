...
void UJSBSimMovementComponent::UpdateLocalTransforms()
{
    if (MassBalance == nullptr || Aircraft == nullptr || GroundReactions == nullptr) {
        UE_LOG(LogTemp, Warning, TEXT("UpdateLocalTransforms: Null pointers detected. Exiting."));
        return;
    }
    ...
    try {
        ...
        if (MassBalance) {
            ...
            UE_LOG(LogTemp, Warning, TEXT("UpdateLocalTransforms: MassBalance is null. Skipping gravity center calculation."));
        }
        ...
        if (Aircraft) {
            ...
            UE_LOG(LogTemp, Warning, TEXT("UpdateLocalTransforms: Aircraft is null. Skipping eye position calculation."));
        }
        ...
        if (Aircraft) {
            ...
            UE_LOG(LogTemp, Warning, TEXT("UpdateLocalTransforms: Aircraft is null. Skipping visual reference position calculation."));
        }
        ...
        if (GroundReactions) {
            ...
            UE_LOG(LogTemp, Warning, TEXT("UpdateLocalTransforms: GroundReactions is null. Skipping gear locations calculation."));
        }

    } catch (const std::exception& e) {
        UE_LOG(LogTemp, Warning, TEXT("UpdateLocalTransforms: Exception caught: %s"), *FString(e.what()));
    }
}
